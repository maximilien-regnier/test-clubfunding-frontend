        ...
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to={`/tasks/new?project_id=${id}`} className="btn btn-secondary">
                Nouvelle tâche
              </Link>
              <button 
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="join">
              <button 
                className={`btn join-item ${statusFilter === 'all' ? 'btn-active' : ''}`}
                onClick={() => setStatusFilter('all')}
              >
                Toutes
              </button>
              <button 
                className={`btn join-item ${statusFilter === 'pending' ? 'btn-active' : ''}`}
                onClick={() => setStatusFilter('pending')}
              >
                En cours
              </button>
              <button 
                className={`btn join-item ${statusFilter === 'completed' ? 'btn-active' : ''}`}
                ...
                <div className="text-center">
                  ...
                  <p className="text-base-content/70 mb-4">
                    {statusFilter === 'all' 
                      ...
                      : `Aucune tâche ${statusFilter === 'pending' ? 'en cours' : 'terminée'}.`
                    }
                  </p>
